...
fun SummaryCard(chapter: SingleChapter) {
    OutlinedCard {
        Text(text = "Summary", Modifier.padding(10.dp), fontWeight = FontWeight.SemiBold, fontSize = 18.sp)
...
private fun MeaningCard(chapter: SingleChapter) {
    ...
    OutlinedCard(
        ...
        Text(text = "Meaning", Modifier.padding(10.dp), fontWeight = FontWeight.SemiBold, fontSize = 18.sp)
        Card(
            modifier = Modifier.fillMaxWidth(),
            colors = CardDefaults.cardColors(containerColor = MaterialTheme.colorScheme.primaryContainer),
